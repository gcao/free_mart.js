...
(function() {
  var FreeMartInternal, FuzzyRegistry, HashRegistry, InUse, NOT_FOUND, NOT_FOUND_FINAL, NO_PROVIDER, Provider, Registry, VERSION, ValueProvider, extend, isDeferred, stringify, stringifyCache, stringifyCallback, toString,
  ...
  Provider = (function() {
    ...
    function Provider(market, value) {
      this.market = market;
      this.value = value;
      this.market.log("Provider.constructor", this.value);
    }
  ...
  ValueProvider = (function(_super) {

    __extends(ValueProvider, _super);

    function ValueProvider() {
      return ValueProvider.__super__.constructor.apply(this, arguments);
    }

    ValueProvider.prototype.process = function() {
      var args, options, result, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      (_ref = this.market).log.apply(_ref, ["ValueProvider.process"].concat(__slice.call(args)));
      result = this.value;
      options = args[0];
      if (options != null ? options.async : void 0) {
        return new Deferred().resolve(result);
  ...
  FreeMartInternal = (function() {
    ...
    FreeMartInternal.prototype.register = function(key, value) {
      ...
      this.log('register', key, value);
      provider = new Provider(this, value);
    ...
    FreeMartInternal.prototype.value = function(key, value) {
      ...
      provider = new ValueProvider(this, value);
      this.registry.add(key, provider);
      if (this.queues[key]) {
        _ref = this.queues[key];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
