...
(function() {
  var CallbackRegistry, FreeMartInternal, FuzzyRegistry, HashRegistry, InUse, NOT_FOUND, NOT_FOUND_FINAL, NO_PROVIDER, Provider, Registry, VERSION, extend, isDeferred, stringify, stringifyCache, stringifyCallback, toString,
  ...
  Provider = (function() {
    ...
    Provider.prototype.process = function() {
      ...
      })(this.value, args, function(){}) : (typeof this.value === 'object' || typeof this.value === 'function') && typeof this.value.$get === 'function' ? this.value.$get.bind(this.value).apply(null, args) : typeof this.value === 'function' ? this.value.apply(this, args) : this.value;
      options = args[0];
